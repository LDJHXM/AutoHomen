...
/**
 * Created by DJ on 2016/11/29.
 */

public class ViewPageAdapter4 extends PagerAdapter {
    private Context context;
    private List<String> images;
    private SparseArray<View> cacheView;
    private ViewGroup containerTemp;

    public ViewPageAdapter4(Context context, List<String> images) {
    ...
    public Object instantiateItem(final ViewGroup container, int position) {
        ...
        if(view == null){
            view = LayoutInflater.from(context).inflate(R.layout.abc_viewpager,container,false);
